...
(function (global, factory) {
	...
	const USE_FLOAT_32_ARRAYS = false; // true by default
	...
	let Float32Array = USE_FLOAT_32_ARRAYS ? globalThis.Float32Array : Arrayish;
    ...
    class NeuralNetworkGPU extends NeuralNetwork {
        constructor(options = {}) {
            ...
            this.gpu = new gpu_js({ mode: options.mode });
        }
        initialize() {
            super.initialize();
            this.buildRunInput();
